...
import { useImovelInfiniteList } from "@/slices/appointments/entidades/imovel/imovelInfiniteList.hook";
...
export const ImoveisPage = () => {
  const { isFetching, imovelList, fetchNextPage, hasNextPage } = useImovelInfiniteList();
  useInfiniteFullList({ fetchNextPage, hasNextPage, isFetching });

  return (
    <Box>
      <Header />
      <GridWithAddToCartButton data={{ imovels: imovelList }} />
      <Sobre />
      <FAQ faqs={faqs} />
      <SmallWithSocial />
    </Box>
