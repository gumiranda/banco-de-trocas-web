...
export const PhotoUpload = ({ setPhotos }) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Tooltip label="Clique aqui enviar as fotos" aria-label="Enviar fotos">
          ...
          {filesAccepted?.length > 0 && (
            <Tooltip
              label="Clique para confirmar o upload das fotos"
              aria-label="Confirmar envio das fotos"
            >
              <Button
                id="file-upload-trigger"
                ...
                onClick={onOpen}
              >
                {isUploading ? <Spinner size="sm" /> : "Confirmar envio"}
              </Button>
            </Tooltip>
          )}
        </Flex>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalBody color="gray.700">
            Tem certeza que deseja fazer o upload desses arquivos?
          </ModalBody>
          <ModalFooter>
